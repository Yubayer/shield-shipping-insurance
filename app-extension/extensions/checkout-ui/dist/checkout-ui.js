...
${errorInfo.componentStack}`);
  ...
  function Extension() {
    ...
    const [protectionProduct, setProtectionProduct] = (0, import_react12.useState)(null);
    const [protectionCost, setProtectionCost] = (0, import_react12.useState)(0);
    const [isFirstRender, setIsFirstRender] = (0, import_react12.useState)(true);
    const [isChecked, setIsChecked] = (0, import_react12.useState)(false);
    const [product_id, setProduct_id] = (0, import_react12.useState)(null);
    const [product_admin_id, setProduct_admin_id] = (0, import_react12.useState)(null);
    const [appUrl, setAppUrl] = (0, import_react12.useState)(null);
    const [isRegular, setIsRegular] = (0, import_react12.useState)(true);
    const [firstLoad, setFirstLoad] = (0, import_react12.useState)(true);
    ...
    (0, import_react12.useEffect)(() => {
      ...
      if (metafields) {
        metafields == null ? void 0 : metafields.forEach((metafieldSet) => {
    ...
    (0, import_react12.useEffect)(() => {
      var _a;
      const lineWithProduct = cartLines.find((line) => {
        var _a2, _b;
        return ((_b = (_a2 = line.merchandise) == null ? void 0 : _a2.product) == null ? void 0 : _b.id) === product_admin_id;
      });
      if (lineWithProduct) {
        ...
        if (isRegular) {
          if ((_a = lineWithProduct.attributes) == null ? void 0 : _a.find((attr) => attr.key === "checkout_type")) {
            setIsChecked(true);
          } else {
            setIsChecked(false);
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_jsx_runtime4.Fragment, { children: protectionProduct && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
      Checkbox2,
      {
        checked: isChecked,
        onChange: () => {
        ...
        children: [
          isChecked ? "Added" : "Add",
          " Order Protection - ",
          protectionProduct.cost.totalAmount.currencyCode,
          " ",
          protectionCost
        ]
      }
