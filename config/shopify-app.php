...
return [
    ...
    */
    ...
    'route_names' => [
        ...
        'authenticate' => env('SHOPIFY_ROUTE_NAME_AUTHENTICATE', 'auth-shop'),
    ...
    */
    ...
    'api_redirect' => env('SHOPIFY_API_REDIRECT', '/auth-shop'),
    ...
    */
    ...
    'listen' => [
        ...
        \Osiset\ShopifyApp\Messaging\Events\AppUninstalledEvent::class => [
            // \App\Listeners\MyListener::class,
            // \App\Listeners\AppUninstalledEventListener::class,
        ],
    ...
    */
    ...
    'webhooks' => [
        ...
        //     'address' => env('SHOPIFY_WEBHOOK_UNINSTALLED_APP')
        // ],
        //order create
        // [
        //     'topic' => env('SHOPIFY_WEBHOOK_2_TOPIC', 'ORDERS_CREATE'),
        //     'address' => env('SHOPIFY_WEBHOOK_ORDERS_CREATE')
        // ],
        //order fullfillment
        // [
        //     'topic' => env('SHOPIFY_WEBHOOK_3_TOPIC', 'ORDERS_FULFILLED'),
        //     'address' => env('SHOPIFY_WEBHOOK_ORDERS_FULFILLED')
        // ],
        //orders paid
        // [
        ...
        //DRAFT_ORDERS_CREATE
        // [
        //     'topic' => env('SHOPIFY_WEBHOOK_5_TOPIC', 'DRAFT_ORDERS_CREATE'),
        //     'address' => env('SHOPIFY_WEBHOOK_DRAFT_ORDERS_CREATE')
        // ], 
        //DRAFT_ORDERS_DELETE
        // [
        //     'topic' => env('SHOPIFY_WEBHOOK_6_TOPIC', 'DRAFT_ORDERS_DELETE'),
        //     'address' => env('SHOPIFY_WEBHOOK_DRAFT_ORDERS_DELETE')
        // ], 
    ],
